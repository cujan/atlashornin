<?php //netteCache[01]000432a:2:{s:4:"time";s:21:"0.04531800 1391506909";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:117:"C:\Program Files\EasyPHP-DevServer-13.1VC9\data\localweb\atlashornin\app\FrontModule\templates\Homepage\default.latte";i:2;i:1391506854;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2013-12-31";}}}?><?php
...
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'n576djyeif')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lbdf6eeb9865_content')) { function _lbdf6eeb9865_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lb17ef5f7d3f_title')) { function _lb17ef5f7d3f_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lbd13367186d_scripts')) { function _lbd13367186d_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbecc0f76119_head')) { function _lbecc0f76119_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
