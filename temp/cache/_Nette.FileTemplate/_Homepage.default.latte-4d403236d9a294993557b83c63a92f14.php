<?php //netteCache[01]000448a:2:{s:4:"time";s:21:"0.64448600 1391376364";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:133:"C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\atlasHornin\app\FrontModule\templates\Homepage\default.latte";i:2;i:1391354508;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:22:"released on 2013-12-31";}}}?><?php

// source file: C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\atlasHornin\app\FrontModule\templates\Homepage\default.latte

?><?php
// prolog Nette\Latte\Macros\CoreMacros
list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, '52gdia4krz')
;
// prolog Nette\Latte\Macros\UIMacros
//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb23e6158fbb_content')) { function _lb23e6158fbb_content($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
<?php call_user_func(reset($_l->blocks['title']), $_l, get_defined_vars())  ?>
</div>

<div id="content">
	<h2>You have successfully created your Nette Framework project. Front</h2>
...
// block title
//
if (!function_exists($_l->blocks['title'][] = '_lbebc0d383bd_title')) { function _lbebc0d383bd_title($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_l->blocks['scripts'][] = '_lb54eba3f879_scripts')) { function _lb54eba3f879_scripts($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lbb5d1ca9916_head')) { function _lbb5d1ca9916_head($_l, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
